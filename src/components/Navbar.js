...
const Navbar = () => {
    ...
    const adminMenu = (
        <>
            <Link to="/accounts" className="hover:bg-blue-400 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">
                <li className="rounded text-gray-200 hover:text-gray-900 bg-blue-500 hover:bg-blue-600 p-2">
                    Accounts
                </li>
            </Link>
            <Link to="/arbitri" className="hover:bg-blue-400 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">
                <li className="rounded text-gray-200 hover:text-gray-900 bg-blue-500 hover:bg-blue-600 p-2">
                    Arbitri
                </li>
            </Link>
    ...
    const userMenu = (
        <>
            <Link to="/report" className="hover:bg-blue-400 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">
                <li className="rounded bg-blue-500 hover:bg-blue-600 text-gray-200 hover:text-gray-900 p-2">
                    Report
                </li>
            </Link>
            <button 
                className="hover:bg-blue-400  md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0"
                onClick={logout}    
            >
                <li className="rounded bg-blue-500 hover:bg-blue-600 text-gray-200 hover:text-gray-900 p-2">
                    Logout
