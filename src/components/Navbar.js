        ...
        <>
            ...
            <nav className="bg-gradient-to-r from-blue-600 to-blue-400 border-gray-200 px-2">
                <div className="container mx-auto flex flex-wrap items-center justify-between">
                    ...
                    <div className="hidden md:block w-full md:w-auto hide-element" id="mobile-menu">
                        <ul className="flex-col md:flex-row flex md:space-x-8 mt-4 md:mt-0 md:text-sm md:font-medium">
                            <li>
                                <a href="#" className="bg-gray-300 md:bg-transparent text-blue-700 block pl-3 pr-4 py-2 md:text-gray-100 md:p-0 rounded" aria-current="page">Home</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-200 hover:text-gray-900 hover:bg-blue-400 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">About</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-200 hover:text-gray-900 hover:bg-blue-400 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Services</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-200 hover:text-gray-900 hover:bg-blue-400 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Pricing</a>
                            </li>
                            <li>
                                <a href="#" className="text-gray-200 hover:text-gray-900 hover:bg-blue-400 border-b border-gray-100 md:hover:bg-transparent md:border-0 block pl-3 pr-4 py-2 md:hover:text-blue-700 md:p-0">Contact</a>
                            </li>
                        </ul>
                    </div>
                </div>
